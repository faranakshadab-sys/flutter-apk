...
import '../../domain/models/add-plate-identity-model.dart';
...
class CommonRepositoryImpl extends CommonRepository {
  ...
  Future<Either<AppFailure, bool>> submitPaymentStatus(
    ...
    var response = await remoteDatasource.submitPaymentStatus(
        reportId: reportId, totalAmount: totalAmount, referenceId: referenceId);
  ...
  @override
  Future<Either<AppFailure, ReportViewModel>> exitVehicle(
      {required int id}) async {
    var response = await remoteDatasource.exitVehicle(id: id);
